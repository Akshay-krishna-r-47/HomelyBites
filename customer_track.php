    ...
    <div class="main-content">
        ...
        <div class="content-container">
            ...
            <div class="empty-state">
                ...
                <p style="color: #7f8c8d; font-size: 1.1rem;">You have no active orders to track.</p>
                <a href="customer_dashboard.php" style="display: inline-block; margin-top: 15px; color: var(--brand-green); font-weight: 700;">Place an Order</a>
            </div>
        </div>
    </div>
