...
<head>
    ...
    <title>Scheduled Deliveries - Homely Bites</title>
    ...
    <div class="main-content">
        ...
        <div class="content-container">
            ...
            <div class="empty-state">
                ...
                <p style="color: #7f8c8d; font-size: 1.1rem;">No scheduled deliveries found.</p>
                <a href="customer_dashboard.php" style="display: inline-block; margin-top: 15px; color: var(--brand-green); font-weight: 700;">Find Food</a>
            </div>
        </div>
    </div>
