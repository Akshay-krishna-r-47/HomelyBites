...
<head>
    ...
    <style>
        :root { --primary-color: #27ae60; --brand-green: #0a8f08; --bg-body: #f8f8f8; --card-bg: #FFFFFF; --text-dark: #222; --text-muted: #666; --sidebar-width: 280px; --header-height: 80px; }
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Poppins', sans-serif; }
        ...
        .page-header h2 { font-weight: 700; font-size: 2.2rem; color: var(--text-dark); margin-bottom: 5px; }
